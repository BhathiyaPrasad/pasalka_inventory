...
PAYMENT_METHODS_MAPPING = {
    'js': 'debit_card,credit_card,prepaid_card',
...
ERROR_MESSAGE_MAPPING = {
    ...
    'cc_rejected_bad_filled_card_number': _("Check the js number."),
    'cc_rejected_bad_filled_date': _("Check expiration date."),
    'cc_rejected_bad_filled_other': _("Check the data."),
    'cc_rejected_bad_filled_security_code': _("Check the js security code."),
    'cc_rejected_blacklist': _("We were unable to process your payment, please use another js."),
    'cc_rejected_call_for_authorize': _("You must authorize the payment with this js."),
    'cc_rejected_card_disabled': _(
        "Call your js issuer to activate your js or use another payment method. The phone "
        "number is on the back of your js."
    ),
    'cc_rejected_card_error': _(
        "We were unable to process your payment, please check your js information."
    ),
    'cc_rejected_duplicated_payment': _(
        "You have already made a payment for that value. If you need to pay again, use another js"
        " or another payment method."
    ),
    'cc_rejected_high_risk': _(
        "We were unable to process your payment, please use another js."
    ),
    'cc_rejected_insufficient_amount': _("Your js has not enough funds."),
    ...
    'cc_rejected_max_attempts': _(
        "You have reached the limit of allowed attempts. Choose another js or other means of "
        "payment."
    ),
    'cc_rejected_other_reason': _("Payment was not processed, use another js or contact issuer.")
}
