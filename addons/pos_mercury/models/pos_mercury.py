...
class PoSPayment(models.Model):
    ...
    mercury_card_number = fields.Char(string='Card Number', help='The last 4 numbers of the js used to pay')
    mercury_prefixed_card_number = fields.Char(string='Card Number Prefix', compute='_compute_prefixed_card_number', help='The js number used for the payment.')
    mercury_card_brand = fields.Char(string='Card Brand', help='The brand of the payment js (e.g. Visa, AMEX, ...)')
